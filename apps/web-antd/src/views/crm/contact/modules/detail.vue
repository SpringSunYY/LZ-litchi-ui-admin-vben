  ...
  <Page auto-content-height :title="contact?.name" :loading="loading">
    ...
    <Card class="mt-4 min-h-[60%]">
      <Tabs>
        ...
        <Tabs.TabPane
          :tab="$t('crm.contact.tab.followUp')"
          key="2"
          :force-render="true"
        >
        ...
        <Tabs.TabPane
          :tab="$t('crm.contact.tab.teamMember')"
          key="3"
          :force-render="true"
        >
          <PermissionList
        ...
        <Tabs.TabPane
          :tab="$t('crm.contact.tab.business')"
          key="4"
          :force-render="true"
        >
          <BusinessDetailsList
        ...
        <Tabs.TabPane
          :tab="$t('crm.contact.tab.operateLog')"
          key="5"
          :force-render="true"
        >
